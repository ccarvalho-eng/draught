...
<img width="650" src="https://github.com/user-attachments/assets/6e04aca4-65fd-40c4-a079-dd1fc64e24ed" />

## Installation

Download the archive for the current operating system and architecture from the `v0.1.1-beta.10` release. The available targets are:
