...
```
/skill elixir-phoenix-work  # Find most recent IN_PROGRESS plan, resume from first [ ]
```

### From Specific Task

```
/skill elixir-phoenix-work .draught/plans/auth/plan.md --from P2-T3
```
...
```
/skill elixir-phoenix-work .draught/plans/auth/plan.md --skip-blockers
```
