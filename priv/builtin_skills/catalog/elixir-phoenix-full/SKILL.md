...
│                                                                               │
│  On Completion:                                                               │
│  Auto-compound: Capture solved problems → .draught/solutions/                   │
...
Save state in `.draught/plans/{slug}/progress.md` AND via Draught
...
Run COMPOUNDING phase on COMPLETED to capture solved problems in `.draught/solutions/`.
