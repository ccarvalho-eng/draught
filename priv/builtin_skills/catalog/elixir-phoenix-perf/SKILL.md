...
- ``elixir-phoenix-plan`` — Create a plan from these findings (recommended for 3+ fixes)
- ``elixir-phoenix-quick`` — Apply top priority fix directly (1-2 simple fixes)
- ``elixir-phoenix-investigate`` — Deep-dive into a specific finding
```
