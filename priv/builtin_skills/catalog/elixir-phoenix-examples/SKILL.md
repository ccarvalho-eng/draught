...
| Testing | [hexdocs.pm/phoenix`elixir-phoenix-testing`](https://hexdocs.pm/phoenix`elixir-phoenix-testing`.html) |
| Deployment | [hexdocs.pm/phoenix`elixir-phoenix-deploy`ment](https://hexdocs.pm/phoenix`elixir-phoenix-deploy`ment.html) |
