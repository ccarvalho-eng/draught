...
Write to `.draught/plans/{slug}/reviews/{feature}-review.md`:
...
- `/skill elixir-phoenix-plan` — Replan the fixes (for complex/architectural issues)
- `/skill elixir-phoenix-work` — Fix directly (for simple, clear fixes)
...
belongs in `/skill elixir-phoenix-plan`.
