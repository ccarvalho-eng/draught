...
Detailed step-by-step execution for `/skill elixir-phoenix-full`.
...
# Create directories
mkdir -p .draught/plans/${FEATURE_SLUG}/{research,reviews,summaries}
...
Run `/skill elixir-phoenix-plan {feature}` (with `--detail comprehensive` for "research it"):

- Spawn research agents (1-2 for standard, 4+ for comprehensive)
- Create phased implementation plan
- Write `.draught/plans/{feature}/plan.md`

**Exit condition**: Plan file exists with checkboxes.

## Step 4: Work Phase (Loop)

Run `/skill elixir-phoenix-work .draught/plans/{feature}/plan.md`:
...
Run `/skill elixir-phoenix-review`:
...
- `/skill elixir-phoenix-document` for documentation generation
- `/skill elixir-phoenix-learn-from-fix` to capture lessons learned
...
- Plan: .draught/plans/{feature}/plan.md
- Progress: .draught/plans/{feature}/progress.md
- Review: .draught/plans/{feature}/reviews/{feature}-review.md
