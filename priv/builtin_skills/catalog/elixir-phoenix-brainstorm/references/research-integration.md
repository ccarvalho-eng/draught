...
Detailed methodology for the research phase of `/skill elixir-phoenix-brainstorm`.
...
Write analysis to: .draught/plans/{slug}/research/codebase-scan.md
...
Update `.draught/plans/{slug}/interview.md` with research findings
...
### `.draught/plans/{slug}/research/codebase-scan.md`
...
### `.draught/plans/{slug}/research/external.md`
...
## Integration with /skill elixir-phoenix-plan

When `/skill elixir-phoenix-plan` detects `.draught/plans/{slug}/interview.md` with research:
