...
When `/skill elixir-phoenix-research --library` or evaluating a Hex dependency,
use this structured template instead of free-form research.

## Workflow

1. Check hex.pm stats (downloads, recent releases, maintenance)
...
Write to `.draught/research/{library-name}-evaluation.md`:
...
- "Plan the integration" -> `/skill elixir-phoenix-plan`
