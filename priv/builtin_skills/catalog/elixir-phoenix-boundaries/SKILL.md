...
```
- ``elixir-phoenix-plan`` — Create a plan to fix violations (recommended for 3+ issues)
- ``elixir-phoenix-quick`` — Fix a single boundary violation directly
- ``elixir-phoenix-review`` — Review specific modules for deeper issues
```
